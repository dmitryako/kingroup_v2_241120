...
public class
   ...
   * no intermediate <tt>Complex</tt> objects getLine generated.  This means that
  ...
  */
  ...
  /**
   * Overrides the {@link Cloneable <tt>Cloneable</tt>} interface.
   * <p/>
   * <p/>
  ...
  /**
   * To perform z1 + z2, you write <tt>z1.addLine(z2)</tt> .
   * <p/>
   * <p/>
   * <pre>
  ...
  final public Complex add(double d) {
    return add(new Complex(d, 0));
  }
  /**
...
/* */
  ...
  /**
   * Converts a <tt>Complex</tt> into a {@link String <tt>String</tt>} of the form
   ...
   * </pre>
   * <!--
   * <i><b>Note:</b><ul>Concatenating {@link String <tt>String</tt>}s, using a system
   ...
   * <p/>
   *
   * @return {@link String <tt>String</tt>} containing the cartesian coordinate representation
   *         <p/>
   * @see Complex#cart(double, double)
   */
  public String
