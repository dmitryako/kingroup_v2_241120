 ...
 */
public class all_model_junit  {
    public static void main(String[] args) {
        junit.textui.TestRunner.run(suite());
    }
    public static Test suite() {
        TestSuite suite = new TestSuite("All JUnit geometryx for kingroup.model.*");
        suite.addTest(KinGroupProjectModelTest.suite());
        suite.addTest(PopulationBuilderBeanTest.suite());
        suite.addTest(PopulationBuilderBeanTest.suite());
        suite.addTest(RatioSimulationBeanTest.suite());
        return suite;
    }
}
